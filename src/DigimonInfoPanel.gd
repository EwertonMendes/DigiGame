...
func _layout_card() -> void:
	...
	_rank_label.position = Vector2(identity_x + 48.0, 50.0)
	_rank_label.size = Vector2(maxf(48.0, identity_w - 48.0), 20.0)
	_rank_label.add_theme_font_size_override("font_size", 7 if compact else 9)
	_attribute_label.position = Vector2(identity_x, 72.0)
	...
	_sp_label.position = Vector2(bar_left, bars_y + 25.0)
	_sp_label.size = Vector2(bar_width, 14.0)
	_sp_bar.position = Vector2(bar_left, bars_y + 39.0)
	...
	_mov_label.add_theme_font_size_override("font_size", 7 if compact else 9)
	_spd_label.add_theme_font_size_override("font_size", 7 if compact else 9)
